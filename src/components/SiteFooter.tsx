...
export function SiteFooter() {
  return (
    ...
    <footer className="global-site-footer relative self-start ml-6 mt-6 z-0 flex items-center gap-3 text-hyde-bone-dim md:fixed md:bottom-6 md:left-6 md:z-40 md:mt-0 md:ml-0">
      {socials.map((s) => (
        <a
          key={s.name}
          href={s.href}
